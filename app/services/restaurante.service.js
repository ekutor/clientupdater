...
var RestauranteService = (function () {
    ...
    RestauranteService.prototype.addRestaurante = function (restaurante) {
        ...
        return this._http.post("http://localhost:8080/slim2/public/restaurantes", params, { headers: headers }).map(function (res) { return res.json(); });
    };
    RestauranteService.prototype.editRestaurante = function (id, restaurante) {
        var json = JSON.stringify(restaurante);
        var params = "json=" + json;
        var headers = new http_1.Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
        return this._http.post("http://localhost:8080/slim2/public/update-restaurante/" + id, params, { headers: headers }).map(function (res) { return res.json(); });
    };
